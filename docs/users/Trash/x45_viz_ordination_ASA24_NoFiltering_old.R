...
# Save by_user plot as a pdf. 
  ggsave("Viz_Ordination/VVKAJ_Items_f_id_s_m_QCed_4Lv_ord_WEIGHTED_users_Axis12.png", by_user,
         device="png", height=5, width=7, unit="in", dpi=300)
...
# Save highlighted as a pdf.
  ggsave("Viz_Ordination/VVKAJ_Items_f_id_s_m_QCed_4Lv_ord_WEIGHTED_users_Axis12_highlighted.png", 
         highlighted, device="png", height=5, width=7, unit="in", dpi=300)
