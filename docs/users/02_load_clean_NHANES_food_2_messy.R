...
# # Among the individuals in food12d_demo, selected only those in QCtotals_demo. 
...
### THE CODE BELOW HAS BEEN ADDED TO TUTORIAL. THIS WORKS WITH CREATE FOOD TREE SCRIPT.
