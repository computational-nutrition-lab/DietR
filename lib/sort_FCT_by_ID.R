# ===============================================================================================================
# Sort FCT table rows (individuals) in alphanumeric order while leaving the taxonomy column intact at the end.
# This food is to be used in ordination.
# Version 1
# Created on 02/14/2023 by Rie Sadohara
# "OTU" was changed to "FCT" on 06/22/2023 by Rie Sadohara
# ===============================================================================================================
...
# ===============================================================================================================
  ...
  SortFCTByID <- function(fct.input, outfn.for.corr.axis){
    
    # Load input food FCT table - this is our food FCT data
    food_raw <- read.delim(fct.input, row.names = 1)
...
# Example:
  ...
  # SortFCTByID(otu.input = "Foodtree/VVKAJ_Items_f_id_s_m_QCed_4Lv.food.otu.txt",
