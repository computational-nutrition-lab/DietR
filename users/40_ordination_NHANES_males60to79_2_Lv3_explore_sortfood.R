# ===============================================================================================================
# Sort SEQNs (columnnames of food_raw) in numeric order before building a phyfoods object.
...
# Updated on 12/02/2022 by Rie Sadohara.
# ===============================================================================================================
...
# Food - copied from "40_ordination_NHANES_males60to79_Lv3_Euclidean_sortfood.R".
  # Load food OTU table - this is our food OTU data
  # food_raw <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv3.dhydrt.otu.txt", row.names=1)
  food_raw <- read.delim("Foodtree/Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv.food.otu.txt", row.names=1)
...
# Taxonomy (tax)
  ...
  # tax <- read.delim("Foodtree/Food_D12_FC_cc_f_males60to79_red_Lv3.taxonomy.txt")
  tax <- read.delim("Foodtree/Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv.tax.txt")
...
# Food tree
  ...
  foodtree <- read_tree("Foodtree/Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv.nwk")
...
# Save the percent variance explained as a txt file.
  Eigen(eigen.input = eigen_percent_w, 
       # output.fn="Food_D12_FC_cc_f_males60to79_red_Lv3_ord_WEIGHTED_eigen.txt")
        output.fn="Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_WEIGHTED_eigen.txt")
...
# The merged dataframe, 'meta_usersdf', will be used for plotting.
  MergeAxesAndMetadata_NHANES(ord.object= ordinated_w, number.of.axes= 10, meta.data= demog_glu, 
                              output.fn= "Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_WEIGHTED_meta_users.txt")
...
# Load the output again for plotting.
  ...
  loaded_glu_w <- read.table("Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_WEIGHTED_meta_users.txt",
                             sep="\t", header=T)
...
# Load the eigenvalues as a vector.
  eigen_loaded <- read.table("Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_WEIGHTED_eigen.txt", header=T)
...
# dot.colors are for datapoints, and ellipses.colors are for ellipses outlines. 
  PlotAxis1to4ByFactor(axis.meta.df    = loaded_glu_w, 
                       ...
                       out.prefix = "Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_WEIGHTED"
                       )
...
# Save the percent variance explained as a txt file.
  Eigen(eigen.input = eigen_percent_u, 
        ...
        output.fn="Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_Unweighted_eigen.txt")
...
# The merged dataframe, 'meta_usersdf', will be used for plotting.
  MergeAxesAndMetadata_NHANES(ord.object= ordinated_u, number.of.axes= 10, meta.data= demog_glu, 
                              ...
                              output.fn= "Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_Unweighted_meta_users.txt")
  
# Load the output again for plotting.
  loaded_glu_u <- read.table("Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_Unweighted_meta_users.txt",
                             sep="\t", header=T)  
...
# [NOTE} For UNweighted results, change the input, eigen vectors, and prefix names accordingly. 
  PlotAxis1to4ByFactor(axis.meta.df    = loaded_glu_u, 
                       ...
                       out.prefix = "Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_Unweighted"
  )
...
# Generate and save an WEIGHTED unifrac distance matrix of "Samples". 
  WeightedUnifracDis(input.phyloseq.obj = phyfoods, 
                     output.fn = "Food_D12_FC_QC_demo_QCed_w_FoodCodeID_males60to79_red_3Lv_ord_Unweighted_uni_dis.txt")        
