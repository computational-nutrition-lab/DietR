...
# Load data.                
  ...
  QCed.foods <- read.delim("VVKAJ_Items_f_id_s_m_QCed.txt", quote="", colClasses = "character") # quote="" added.
...
#   appending column names to file
  MakeFoodOtu(food_records_fn=  "VVKAJ_Items_f_id_s_m_QCed.txt",  # same as food_records_fn in FilterDbByDietRecords 
              ...
              food_taxonomy_fn= "Foodtree/VVKAJ_Items_f_id_s_m_QCed_red_4Lv.tax.txt",  # Specify your taxonomy file produced by MakeFoodTree.
              output_fn =       "Foodtree/VVKAJ_Items_f_id_s_m_QCed_red_4Lv.food.otu.txt")  # Name your output otu file.
