...
# The 'data' argument needs the original input for PCA, not after selecting specific variables.
  ...
  ggsave("males60to79_Nut_PCA/males60to79_Nut_PCA_by_GLU_index_PC12.pdf", 
...
# Your input data should be a data frame with variables with non-zero variance. 
  pca_input <- read.table("males60to79_QCtotal_d_ga_body_meta_glu_comp_2_Cat_rv.txt",
                          sep="\t", header=T)
...
# Use the autoplot function. Specify which PC in the x and y arguments.
  ...
  ggsave("males60to79_Cat_PCA/males60to79_Cat_PCA_by_GLU_index_PC12.pdf", 
