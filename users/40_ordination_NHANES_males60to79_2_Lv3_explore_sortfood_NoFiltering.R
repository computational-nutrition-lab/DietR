...
# Food 
  ...
  food_raw <- read.delim("Foodtree/Food_D12_FC_QC_demo_QCed_males60to79_3Lv.food.otu.txt", row.names=1)
  ...
  write.table(food, "Foodtree/Food_D12_FC_QC_demo_QCed_males60to79_3Lv.food.otu_sortedbysample.txt",
