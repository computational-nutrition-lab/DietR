# ===============================================================================================================
# Backup of prep for clustering of NHANES, before it is made into function.
# Version 1
# Created on 12/26/2022 by Rie Sadohara
# ===============================================================================================================
...
#### THE NUMBERS (e.g. "there should be xx rows.") MAY BE WRONG... haven't updated that part, but 
# the code itself should be correct.
