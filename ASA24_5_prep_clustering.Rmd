...
Table. Part of descriptors of filenames for data type and processing pattern are defined as follows for each of the combination of two types of dietary data (nutrients or food categories) and two types of measurements (each day or average across days).
...
**Need to do something about this now that AverageBy is used in the ASA24_1_load_and_clean.Rmd.
