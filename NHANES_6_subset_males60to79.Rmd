...
In the previous procedure, we identified males in their 60s and older seem to be an appropriate subsample to analyze their diabetic statuses and diet. We will remove people who are 80 years old or potentially above from our analyses because they may be using meal assistance and thus may not be eating freely.
...
Based on the p-values, Normal and Prediabetic have the same mean BMI (p=0.12832 > 0.05). Normal and Diabetic have different mean BMI (p=0.00056 < 0.05), as do Prediabetic and Diabetic (p=0.00499 < 0.05).   
