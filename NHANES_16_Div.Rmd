...
Load averaged totals data, nutrition & food categories with demographic, gender-age, body measurements, and metadata. From line 118 in 04_add_meta_GLU_index_NHANES.R.
...
As an input, we need to have a table with SEQN as rows and food items as columns. So, we will create a food OTU table first.
