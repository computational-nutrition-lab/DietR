...
![](Screenshots_for_Tutorial/ASA24 Foodtree/all.food.desc.png){width=45%}

<br>

all.food.desc_formatted.txt

![](Screenshots_for_Tutorial/ASA24 Foodtree/all.food.desc_formatted.png){width=80%}
...
![](Screenshots_for_Tutorial/ASA24 Foodtree/soylent_codes.png){width=40%}
...
![](Screenshots_for_Tutorial/ASA24 Foodtree/soylent_codes_formatted.png){width=70%}
...
num.levels |         number of food levels (1 - 5) to save.
...
![](Screenshots_for_Tutorial/ASA24 Foodtree/NodeLabelsMCT.png){width=50%}
