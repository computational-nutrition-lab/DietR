...
First, we will load the QC-ed averaged totals of males 60-79 years old (n=237) and all food records (n=4,207). Then, we will keep the food records of only the individuals in males 60-79 years old and generate a foodtree with the filtered food data. 
...
# Generate OTU tables for downstream analyses.
