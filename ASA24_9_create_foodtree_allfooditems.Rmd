...
The use of the FormatFoods function in 02_load_clean_ASA24.R script has already dealt with it, but it is helpful to know the assumptions which the functions you are going to use were built on.
